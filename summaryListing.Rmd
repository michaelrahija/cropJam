...
The table below shows the number of parcels containing sweet potato, irish potato yellow yam, onion, other crops, and mixed crops by enumeration area. 
```{r, echo=FALSE}
...
## Paradata analysis - ONLY INCLUDES PARADATA FROM FINAL QUESTIONNIARE
### It doesn't include interviews before the other please specify question was added
